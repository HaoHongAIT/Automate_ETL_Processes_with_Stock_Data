...
class XGBoost:
    def __init__(self,data) -> None:
        self.parameters = {'n_estimators': [1_000_000],
                           'max_depth': [3, 8, 10, 12],
    ...
    def train(self):
        # drop columns
        time_dict = {'minutes':[], 'hours':[], 'days':[1, 10, 15, 30]}
        forecasting_index = ['MA', 'SMA', 'EMA', 'RSI', 'MACD']
        preprocessing.calc_index(df, forecasting_index)
...
FPT_ticker.columns
        ...
        clf = GridSearchCV(xgboost, self.parameters)
